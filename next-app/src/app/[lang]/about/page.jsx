...
export default async function About({ params: { lang } }) {
  ...
  return (
    <Body headline="ABOUT US" color1Hex="#718BE9" color2Hex="#2A5057">
      <div className="z-0 flex justify-center relative w-full h-full ">
        <Image className="z-0" src={bg} fill alt="" priority />
        <div className="z-10 flex flex-col w-full gap-4 text-justify text-start items-center justify-center text-[28px] md:text-5xl font-display px-4">
